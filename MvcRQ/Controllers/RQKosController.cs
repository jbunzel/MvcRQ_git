...
namespace MvcRQ.Controllers
{
    ...
    public class RQKosController : BaseController
    {
        ...
        /// </summary>
        /// <remarks>
        /// The action reacts to URLs of type "~/RQKos/id" and returns the RQKosSet with ID=id.
        ...
        /// </param>
        /// <returns>
        /// verb == null: The action returns the RQKosSet with ID=id to be rendered by RQKos/Index view.
        /// verb == new: The action returns an (empty) data entry mask to add a new RQKosSet (not yet implemented).
        /// verb == dt: The action returns the RQKosSet with ID=id according to the DynaTree format. 
        /// </returns>
        ...
        [EnableJson, EnableXml]
        [HttpGet, OutputCache(NoStore = true, Location = OutputCacheLocation.None)]
        public ActionResult RQKosItemRecord(string serviceId, string id, string verb)
        {
            if (verb == "dt")
            ...
            else
            {
                ...
                if (serviceId != null)
                {
                    ...
                    EnableXmlAttribute.XSLTransform = "";
                return View("ServRQKos", GetModel(id, serviceId).RQKosSet);
            }
        }
