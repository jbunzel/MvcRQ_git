...
function UserTableArea() {
  ...
  this.init = function (tableSelector) {
    ...
    $.post(HostAdress() + '/{controllerName}/GetAllUsers', {}, function (users) {
  ...
  function addRemoveRoleForUser(data) {
    ...
    $.post(HostAdress() + "/{controllerName}/AddRemoveRoleForUser", data, function (response) {
...
function AddUserArea() {
  ...
  function createUser(e) {
    ...
    $.ajax({
      type: "POST",
      url: HostAdress() + "/{controllerName}/CreateUser",
      data: postData,
      dataType: "json",
      traditional: true,
...
function RoleManagement() {
  ...
  function fillRoleSelectBox() {
    ...
    $.post(HostAdress() + "/{controllerName}/GetAllRoles", {}, function (roles) {
  ...
  function addRole(roleName) {
    ...
    $.post(HostAdress() + "/{controllerName}/CreateRole", { roleName: roleName }, function (response) {
      _myHelper.processServerResponse(response, function () {
  ...
  function deleteRole(roleName, allowPopulatedRoleDeletion) {
    ...
    $.post(HostAdress() + "/{controllerName}/DeleteRole", { roleName: roleName, allowPopulatedRoleDeletion: allowPopulatedRoleDeletion }, function (response) {
      _myHelper.processServerResponse(response, function () {
