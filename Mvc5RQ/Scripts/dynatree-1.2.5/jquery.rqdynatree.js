...
//          this.isRead = false;
	...
	reloadChildren: function(callback) {
		...
		if(callback){
			var self = this;
			var eventType = "nodeLoaded.dynatree." + this.tree.$tree.attr("id")	+ "." + this.data.key.substring(0, this.data.key.indexOf('$'));
...
//      this.tree.logDebug("%s.addChild(%o, %o)", this, obj, beforeNode);
	...
	appendAjax: function(ajaxOptions) {
		...
		var orgSuccess = ajaxOptions.success,
			...
			eventType = "nodeLoaded.dynatree." + this.tree.$tree.attr("id") + "." + this.data.key.substring(0, this.data.key.indexOf('$'));
