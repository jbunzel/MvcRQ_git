...
- integrating the web user interface with the API parts of the application into the same controller logic,
  (adapting code from Omar Al Zabir: Build Truly RESTful API and Website using Same ASP.NET MVC Code (http://www.codeproject.com/KB/aspnet/aspnet_mvc_restapi.aspxfollowing);
...
- Sub-directory MvcRQ contains the web user interface according to MVC-Architecture. HTML is to a large extent generated via XSLT-Transformations, which optionally can be executed on 
