...
namespace MvcRQUser.Models
{
    public class SettingsDBInitializer : System.Data.Entity.DropCreateDatabaseAlways<SettingsDBContext>
    {
        protected override void Seed(SettingsDBContext context)
        {
            ...
            { 
                new QueryOptions { IncludeExternal = true, Databases = new List<Database>(), DataFields = new List<DataField>(), SortOptionId = 1, UserId = ui } //"a47fb0d7-0c46-472e-b7b0-471e68a3cd80"
            }; 
