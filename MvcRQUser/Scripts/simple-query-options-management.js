...
function AddIncludeExternalCheckBox() {
    ...
    this.init = function (selector) {
        ...
        $.post('/{controllerName}/GetIncludeExternal',
              {},
              function (data) {
        ...
        checkBox.click(function () {
            $.post('/{controllerName}/ChangeIncludeExternal',
              { status: 'changed' },
              function (data) {
...
function selectDatabases(e) {
    ...
    $.post("/{controllerName}/GetExternalDatabaseStatus", {}, function (response) {
        // on success do...
...
function addRemoveDatabaseForUser(data) {
    $.post("/{controllerName}/AddRemoveDatabaseForUser", data, function (response) {
