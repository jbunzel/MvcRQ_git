...
#Region "Private Methods"
        ...
        Protected Function RetrieveClassId() As String
            Try
                RetrieveClassId = CType(Me._classDataClient, ClassificationDataClient).GetClassId(Me.ClassCode)
        ...
        Protected Sub Read()
            ...
            If Me._intClassID > 0 Or Me._strClassID <> "" Then
                ...
                If Not IsNothing(Me._classDataClient) Then CType(Me._classDataClient, ClassificationDataClient).GetClassData(Me)
            End If
        End Sub


        Protected Function Write() As Integer
            If Me._intClassID > 0 Then
                'no class of RQClassificationSystem has ID=0. ClassID=0 is used to retriev the outermost subjClassBranch
                If Not IsNothing(Me._classDataClient) Then CType(Me._classDataClient, ClassificationDataClient).PutClassData(Me)
            End If
            Return 1
        End Function
...
#Region "Constructors"
        ...
        Public Sub New(ByVal classCode As String, ByVal classSystem As SubjClass.ClassificationSystems)
            ...
            Me.ClassID = CType(Me._classDataClient, ClassificationDataClient).GetClassId(Me.ClassCode)
        End Sub
