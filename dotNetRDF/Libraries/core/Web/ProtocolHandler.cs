...
namespace VDS.RDF.Web
{
    ...
    /// <remarks>
    /// <para>
    /// Used to create a Protocol endpoint at a specific fixed URL, if you want to allow URIs relative to this URI to be used to refer to Graphs then use the <see cref="WildcardProtocolHandler">WildcardProtocolHandler</see> instead
    /// </para>
    /// <para>
